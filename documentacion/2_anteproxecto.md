...
- normal: todolos demáis usuarios rexistrados na app. Poden consultar, modificar e gardar en favoritos as diferentes receitas


>TODO
3.3. Normativa
Investigarase que normativa vixente afecta ao desenvolvemento
do proxecto e de que maneira.
...
4. Deseño
Pódese consultar no seguinte enlace a ![Figma - Cocina con Catalina](https://www.figma.com/design/8qsePYT8JKnqSSCSa2tkNm/Cocina-con-Catalina?node-id=0-1&m=dev&t=3Km70Lbld7n7X4mr-1)

Inclúe os diferentes diagramas, esquemas e deseños que axuden a describir mellor o proxecto, detallando os seus compoñentes, funcionalidades, bases de datos e interface.



4.1. Deseño da arquitectura do sistema
Incluír artefactos gráficos que representen:

A aplicación.
Os seus compoñentes.
A súa interrelación (bases de datos, nube, microservizos, etc.).


4.2. Deseño da persistencia de datos
Incluír diagramas relacionados coa persistencia de datos, como por exemplo:

Modelo relacional.
Modelo E/R.
Diagramas de arquivos e paquetes.
Outros.
