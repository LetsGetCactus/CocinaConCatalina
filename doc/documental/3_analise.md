...
- **RF1**. Xestión de clientes 

  - **RF1.1.**. Crear un conta de cliente
...
## 3.4. Requerimentos non funcionais
...
### 3.5.5. Interfaces hardware


### 3.5.6. Interfaces software


## 3.6. Análise de riscos e interesados
